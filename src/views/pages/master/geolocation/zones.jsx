                            ...
                            <Form>
                                <FormGroup>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => {
                                            let data = states.filter((v) => v.name === e.target.value)
                                            data.length > 0 && setselected({...selected,state:data[0]})
                                        }}
                                    >
                            ...
                            <Form>
                                <FormGroup>
                                    ...
                                    <select
                                        className="form-control form-control-lg react-form-input"
                                        onChange={(e) => {
                                            let data = cities.filter((v) => v.name === e.target.value)
                                            data.length> 0 && setselected({...selected,city:data[0]})
                                        }}
                                    >
                                        <option>select</option>
