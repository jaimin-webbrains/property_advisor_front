            ...
            >
              {
                propertyData?.states && propertyData.states.length > 0 ?
                  propertyData.states.map((opt) => <option>{opt.state_name}</option>)
                  : <option>No data</option>
              }
            </select>
            {formik.errors.state && <p style={{ color: 'red' }}>{formik.errors.state}</p>}
          </div>
        </div>
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">
          ...
          <div className="col-sm-10">
            <input
              ...
              className="form-control form-control-lg react-form-input"
            />
            {formik.errors.reraNumber && <p style={{ color: 'red' }}>{formik.errors.reraNumber}</p>}
          </div>
        </div>
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">
          ...
          <div className="col-sm-10">
            <input
              id='certFileName'
              name='certFileName'
              onChange={(event) => { formik.setFieldValue('certFileName', event.currentTarget.files[0]) }}
              type="file"
              className="form-control form-control-lg react-form-input"
            />
            {formik.errors.certFileName && <p style={{ color: 'red' }}>{formik.errors.certFileName}</p>}
          </div>
        </div>
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">
          ...
          <div className="col-sm-10">
            <input
              ...
              onChange={e => formik.setFieldValue('certExtFileName', e.currentTarget.files[0])}
              type="file"
              className="form-control form-control-lg react-form-input"
            />
            {formik.errors.certExtFileName && <p style={{ color: 'red' }}>{formik.errors.certExtFileName}</p>}
          </div>
        </div>
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">
          ...
          <div className="col-sm-10">
            <input
              type="file"
              className="form-control form-control-lg react-form-input"
              onChange={e => formik.setFieldValue('detailsFileName', e.currentTarget.files[0])}
              id='detailsFileName'
              name='detailsFileName'
            />
            {formik.errors.detailsFileName && <p style={{ color: 'red' }}>{formik.errors.detailsFileName}</p>}
          </div>
        </div>
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">
          ...
          <div className="col-sm-10">
            <input
              ...
              name='detailsURL'
            />
            {formik.errors.detailsURL && <p style={{ color: 'red' }}>{formik.errors.detailsURL}</p>}
          </div>
        </div>
            ...
            <div className="col-lg-6 col-md-12 col-xl-6 ptb-15">
              <div className="roe-card-style">
                ...
                <div className="roe-card-body">
                  ...
                  />
                  {formik.errors.lastModifiedDate && <p style={{ color: 'red' }}>{formik.errors.lastModifiedDate}</p>}
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-12 col-xl-6 ptb-15">
              <div className="roe-card-style">
                ...
                <div className="roe-card-body">
                  ...
                  <DatePicker
                    ...
                    calendarClassName="custom-calender-class"
                  />
                  {formik.errors.reraApprovedDate && <p style={{ color: 'red' }}>{formik.errors.reraApprovedDate}</p>}
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-12 col-xl-6 ptb-15">
              <div className="roe-card-style">
                ...
                <div className="roe-card-body">
                  ...
                  <DatePicker
                    ...
                    calendarClassName="custom-calender-class"
                  />
                  {formik.errors.reraProjectStartDate && <p style={{ color: 'red' }}>{formik.errors.reraProjectStartDate}</p>}
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-12 col-xl-6 ptb-15">
              <div className="roe-card-style">
                ...
                <div className="roe-card-body">
                  ...
                  <DatePicker
                    ...
                    calendarClassName="custom-calender-class"
                  />
                  {formik.errors.projectEndDate && <p style={{ color: 'red' }}>{formik.errors.projectEndDate}</p>}
                </div>
              </div>
            </div>
